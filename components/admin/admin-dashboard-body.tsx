    ...
    <div className="min-h-screen bg-background">
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-4 gap-4">
          ...
          <Link href="/admin/settlements" className="block transition hover:opacity-90" prefetch>
          ...
          <Link href="/admin/payouts" className="block transition hover:opacity-90" prefetch>
        ...
        <Card className="border-primary/30 bg-primary/5">
          <CardHeader>
            ...
            <CardDescription>
              로고·도장 이미지, 회사명, 사업자 정보를 관리합니다. 저장 즉시 헤더·영수증에 반영됩니다.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Button asChild className="w-full sm:w-auto">
              <Link href="/admin/company" prefetch>
                회사 정보 관리하기
              </Link>
            </Button>
          </CardContent>
        ...
        <Card>
          ...
          <CardContent className="flex flex-col sm:flex-row gap-3 flex-wrap">
            ...
            <Button asChild variant="outline" className="flex-1 min-w-[120px]">
              <Link href="/admin/settlements" prefetch>
                정산 관리
              </Link>
            </Button>
            <Button asChild variant="outline" className="flex-1 min-w-[120px]">
              <Link href="/admin/payouts" prefetch>
                출금(지급) 관리
              </Link>
            </Button>
            <Button asChild variant="outline" className="flex-1 min-w-[120px]">
              <Link href="/admin/finance-logs" prefetch>
                금액 액션 로그
              </Link>
            </Button>
          </CardContent>
