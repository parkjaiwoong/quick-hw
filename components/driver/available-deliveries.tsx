      ...
      <div className="space-y-2">
        ...
        {deliveries.map((delivery) => {
          ...
          return (
            <div
              key={delivery.id}
              className="grid grid-cols-12 items-center rounded-lg border bg-card px-3 py-3 text-sm hover:bg-accent/30 cursor-pointer"
            ...
            >
              ...
              <div className="col-span-4 truncate">{delivery.pickup_address}</div>
              <div className="col-span-4 truncate">{delivery.delivery_address}</div>
